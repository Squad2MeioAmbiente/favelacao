          ...
          <div class="form-group col-sm">
            ...
            <!-- <div class="row">
              ...
              <div class="col-12">
                ...
                <?php echo $_SESSION['user']['dataNascimento']; ?> </p>
              </div>

              <div class="col-12">
                <p><label>Apelido: </label>
                <?php echo $_SESSION['user']['apelido']; ?> </p>
              </div>
            </div> -->
            ...
            <div class="row">
              <div class="col-12">
                <label>Nível </label>
                <!-- <?php echo $_SESSION['user']['nome']; ?> --><p class="float-right"> 2</p>
              </div>
            
              <div class="col-12">
                
                <label>Medalhas Conquistadas </label>
                <p class="float-right">8</p>
                
              </div>

              <div class="col-12">
                <label>Colocação no Ranking </label>
                <!-- <?php echo $_SESSION['user']['dataNascimento']; ?>--><p class="float-right"> 5º </p>
              </div>
            </div>
            ...
            <label >E-mail</label>
            <input type="email" name="email" class="form-control" id="email" value="<?php echo $_SESSION['user']['email']; ?>" maxlength="50" value="<?php echo $_SESSION['user']['email']; ?>"  required>
