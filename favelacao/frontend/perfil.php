            ...
            <!-- <fieldset> -->
              <!-- <div class="row">
                ...
                <div class="form-group col-sm">
                  ...
                  <input type="text" id="nome" name="nome" maxlength="25"  minlength="5"  class="form-control" pattern="^[^-\s][a-zA-ZÀ-ú ]*" value="<?php echo $_SESSION['user']['nome']; ?>" class="form-control border border-dark " required/>
                  ...
                  <input type="text" id="apelido" name="apelido" pattern="^[^-\s][a-zA-ZÀ-ú ]*" class="form-control border border-dark" value="<?php echo $_SESSION['user']['apelido']; ?>" required/>
