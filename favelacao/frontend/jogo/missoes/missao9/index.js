...
async function back (){
  if((contFrase>331) && (contCenario>331) && (contPersonagem >331)){
...
function medalhaGanhas() {
   ...
   alertMedal.textContent = "MEDALHA ADQUIRIDA : Cores de cada lixeira de recicláveis!"
   ...
   setTimeout(() => {alertRemove.remove()}, 4000)
     ...
     medalSound.play()
      ...
      var url = "../../../../backend/api/user/userMedal/userMedal9.php"
...
function fetchSalvar(){
 var url = "../../../../backend/api/saveGame/save9.php"
