...
async function back (){
  if((contFrase>199) && (contCenario>199) && (contPersonagem >199)){
...
async function next (){ 
 ...
 if((contFrase<=233) && (contCenario<=233) && (contPersonagem <=233)){
 console.log(contFrase)
   contFrase++
   contPersonagem++
   contCenario++
...
function medalhaGanhas() {
   ...
   alertMedal.textContent = "MEDALHA ADQUIRIDA : Plantar broto de feijão!"
   ...
   setTimeout(() => {alertRemove.remove()}, 4000)
     ...
     medalSound.play()
      ...
      var url = "../../../../backend/api/user/userMedal/userMedal7.php"
...
function fetchSalvar(){
 var url = "../../../../backend/api/saveGame/save7.php"
