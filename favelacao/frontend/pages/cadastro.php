            ...
            <div class="form-group">
              ...
              <div class="container">
                ...
                <div class="col-sm">
                  <div class="personagem">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="imgAvatar" id="imgAvatar" value="perso1.png">
                ...
                <div class="col-sm">
                  <div class="personagem">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="imgAvatar" id="imgAvatar" value="perso2.png">
                ...
                <div class="col-sm">
                  <div class="personagem">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="imgAvatar" id="imgAvatar" value="perso3.png">
