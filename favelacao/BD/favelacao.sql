...
INSERT INTO `administrador` (`nome`, `dataNascimento`, `email`, `telefone`, `senha`, `confirmarSenha`, `categoriaSecreta`, `respSecreta`, `data`) VALUES
('admin', '2011-12-31', 'admin@gmail.com', '11-91234-1234', '0192023a7bbd73250516f069df18b500', '0192023a7bbd73250516f069df18b500', 'Desenho preferido', 'tom & jerry', '2021-03-07 01:48:12');
...
--
ALTER TABLE `cenarios`
  MODIFY `idCenario` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `enredo`
  MODIFY `idenredo` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `expressao`
--
ALTER TABLE `expressao`
  MODIFY `idExpressao` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `medalhas`
--
ALTER TABLE `medalhas`
  MODIFY `idmedalhas` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `mural`
  MODIFY `idmural` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `savegame`
  MODIFY `idsavegame` int(11) NOT NULL AUTO_INCREMENT;
