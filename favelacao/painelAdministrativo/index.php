<?php
  ...
  if (isset($_REQUEST['encerrar'])) {
    ...
    echo "<script>
      alert('Atenção: este painel está em desenvolvimento! Assim, para acesso como teste, utilize o login: admin@gmail.com e a senha: admin123.'); 
    </script>";
  }
...
<html lang="pt-br">
  ...
  <body>
      <header>  
         <!--menu-->
        <?php
          include("./menus/menuHorizontalIndex.php")
        ?>
...
<div class="form-signin">  
  <div class="card m-3 mt-6">
    <div class="card-body sombra">
      <h3 class="logAlerta" >Login Administrativo</h3>
      <!-- <div class="card-text">
        <p>teste</p> 
      </div> -->
            <!-- <img class="card-img-top logimg" src="../img/logo_favelacao.png" alt="Imagem de capa do card"> -->
      <form action="./backend/administrador/conect_login.php" name="#" method="post"  class="needs-validation">
    
              <label>Login</label>
              <input type="email" name="email" class="form-control" id="" maxlength="50" placeholder="Digite: admin@gmail.com" required/>
            
              <label>Senha</label>
              <input type="password" name="senha" minlength="8" class="form-control" id="" placeholder="Digite: admin123" required/>
