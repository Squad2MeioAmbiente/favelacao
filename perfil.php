 <?php
  $url = 'http://localhost/API/favelacao-jair/favelacao/favelacao/api/user/read.php';

  $usuarios = json_decode(file_get_contents($url));
  // echo '<pre>';
  // var_dump($usuarios->usuarios[0]->nome);
  //echo '</pre>';
?>
<!DOCTYPE html>
<html lang="pt-br">
  ...
  <body>    
    <div class="bg-img">
     <section class="bloco01">
       ...
       <button type="button" class="btn btn-danger btn-lg">Deletar Conta</button>
     </section>
     ...
     <button class="buttonPlay">
       ...
       <p class="title-dados">Seus dados</p>
        <div class="card-box">
          <h4>Marcelo </h4>
          <h4>10 anos </h4>
          <h4> marcelo@gmail.com </h4>
          <h4>Marcelinho</h4> 
          <button class="button-atualizar btn btn-warning btn-lg">Atualizar</button>         
         </div>            
