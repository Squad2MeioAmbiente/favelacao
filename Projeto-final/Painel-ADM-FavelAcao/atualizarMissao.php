<?php
    ...
    $sql = "SELECT * FROM missao WHERE idmissao=".$_REQUEST['idmissao'];
            ...
            <div class="card-group">
              <div class="card">
                ...
                <label>Título da missão: </label>
                  <input type="text" name="tituloMissao" id="tituloMissao" value=<?php echo $_SESSION['missao']['tituloMissao']?> class="mt-3 form-control" maxlength="25"  minlength="3"  class="form-control" pattern="^[^-\s][a-zA-ZÀ-ú ]*" placeholder="Digite um título" required/>

                  <label class="mt-3" >Missão: </label>
                  <textarea type="text" name="missao" class="mt-3 form-control" required><?php echo $_SESSION['missao']['missao']?></textarea>
                </div>
              </div>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                 <label class="selecaolabel">Personagem: </label>
                  <select class="selecao mb-3" name="personagem" id="personagem">
                    <option value= "<?php echo $_SESSION['missao']['personagem']?>" selected><?php echo $_SESSION['missao']['personagem']?> </option>
                ...
                <div class="card-body">
                  <div class="row-2 expressoes d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <select class="selecao" name="expressao" id="expressao">
                     <option value= "<?php echo $_SESSION['missao']['expressao']?>" selected><?php echo $_SESSION['missao']['expressao']?> </option>
            ...
            <label class="mt-2">Cenário: </label>
                  ...
                  <div> 
                    ...
                    <div class="btnsalvar d-grid gap-2 d-md-flex justify-content-md-end">
                      <button name="btnsalvaMissao" type="submit" class="btn bg-success mb-3"> Atualizar </button>
                    </div>
                </div>
              </div>
            </div>
