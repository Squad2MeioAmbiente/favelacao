      ...
      <div class="card-body">
        ...
        <form  name="tcad" action="#" method="GET" class="" >
          ...
          <div class="form-group">
            ...
            <input type="password" name="confirmarSenha" class="form-control" id="" placeholder="digite sua senha ">
          </div>
          <div class="form-group">
            <label for="confirme">Apelido</label>
            <input type="text" name="apelido" class="form-control" id="" placeholder="digite sua senha ">
          </div>
          <div class="form-group">
            <label for="confirme">Imagem</label>
            <input type="text" name="imgAvatar" class="form-control" id="" placeholder="digite sua senha ">
          </div>
