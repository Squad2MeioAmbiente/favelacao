...
async function back (){
  if((contFrase>234) && (contCenario>234) && (contPersonagem >234)){
...
function medalhaGanhas() {
   ...
   alertMedal.textContent = "MEDALHA ADQUIRIDA : Retirar água parada!"
   ...
   setTimeout(() => {alertRemove.remove()}, 4000)
     ...
     medalSound.play()
      ...
      var url = "../../../../backend/api/user/userMedal/userMedal8.php"
...
function fetchSalvar(){
 var url = "../../../../backend/api/saveGame/save8.php"
