 ...
 async function back (){
   if((contFrase>45) && (contCenario>45) && (contPersonagem >45)){
...
async function next (){ 
  ...
  if((contFrase<=93) && (contCenario<=93) && (contPersonagem <=93)){
  console.log(contFrase)
    contFrase++
    contPersonagem++
    contCenario++
...
function medalhaGanhas() {
    ...
    alertMedal.textContent = "MEDALHA ADQUIRIDA : Doar brinquedo !"
    ...
    setTimeout(() => {alertRemove.remove()}, 4000)
      ...
      medalSound.play()
       ...
       var url = "../../../../backend/api/user/userMedal/userMedal2.php"
...
function questionario() {
  ...
  var no = document.createElement('img');
    ...
    no.setAttribute("onClick", "yes(),  medalhaGanhas()")
...
function fetchSalvar(){
  var url = "../../../../backend/api/saveGame/save2.php"
