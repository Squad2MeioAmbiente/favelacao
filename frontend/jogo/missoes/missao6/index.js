...
async function back (){
  if((contFrase>177) && (contCenario>177) && (contPersonagem >177)){
...
async function next (){ 
 ...
 if((contFrase<=198) && (contCenario<=198) && (contPersonagem <=198)){
 console.log(contFrase)
   contFrase++
   contPersonagem++
   contCenario++
...
function medalhaGanhas() {
   ...
   alertMedal.textContent = "MEDALHA ADQUIRIDA : Usar sacolas retonavéis!"
   ...
   setTimeout(() => {alertRemove.remove()}, 4000)
     ...
     medalSound.play()
      ...
      var url = "../../../../backend/api/user/userMedal/userMedal6.php"
...
function fetchSalvar(){
 var url = "../../../../backend/api/saveGame/save6.php"
