...
async function back (){
  if((contFrase>125) && (contCenario>125) && (contPersonagem >125)){
...
async function next (){ 
 ...
 if((contFrase<=176) && (contCenario<=176) && (contPersonagem <=176)){
 console.log(contFrase)
   contFrase++
   contPersonagem++
   contCenario++
...
function medalhaGanhas() {
   ...
   alertMedal.textContent = "MEDALHA ADQUIRIDA : Recolher recicláveis!"
   ...
   setTimeout(() => {alertRemove.remove()}, 4000)
     ...
     medalSound.play()
      ...
      var url = "../../../../backend/api/user/userMedal/userMedal5.php"
...
function fetchSalvar(){
 var url = "../../../../backend/api/saveGame/save5.php"
