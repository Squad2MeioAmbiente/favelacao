...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container-fluid text-center pb-2 titulo">
       <h1 class="tituloCadastro"><img class="iconPerfil" src="../img/iconPerfil.png" alt=""> Faça seu cadastro </h1><br/>
    </div>
        ...
        <div class="card-body">
          <form action="../../backend/api/user/create.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="password" name="confirmarSenha" class="form-control" placeholder="Confirme sua senha" required/>
