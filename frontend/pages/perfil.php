                            ...
                            <?php if (!isset($_SESSION)) session_start(); ?>
                              ...
                              <div class="col-md-3 mt-4">
                                <!-- <div> -->
                                  <?php if ($_SESSION['medal']['medalha1'] == "TRUE" ){?>
                                    ...
                                    <div class="card-text">
                                      <img class="imagem" src="../img/m1.png">
                                      <p class="imagem"> Entrar para o FavelAção</p>
                                    </div>
                              ...
                              <div class="col-md-3 mt-4">
                                ...
                                <?php if ($_SESSION['medal']['medalha2'] == "TRUE" ){?>
                                  ...
                                  <div class="card-text">
                                    <img class="imagem" src="../img/m2.png">
                                    <p class="imagem"> Doar brinquedo</p>
                                  </div>
                              ...
                              <div class="col-md-3 mt-4">
                                ...
                                <?php if ($_SESSION['medal']['medalha3'] == "TRUE" ){?>
                                  ...
                                  <div class="card-text">
                                    <img  class="imagem" src="../img/m3.png">
                                    <p class="imagem"> Desenhar o meio ambiente</p>
                                  </div>
                              ...
                              <div class="col-md-3 mt-4">
                                ...
                                <?php if ($_SESSION['medal']['medalha4'] == "TRUE" ){?>
                                  ...
                                  <div class="card-text">
                                    <img  class="imagem" src="../img/m4.png">
                                    <p class="imagem"> Descartar óleo de cozinha</p>
                                  </div>
                              ...
                              <div class="col-md-3 mt-4">
                                ...
                                <?php if ($_SESSION['medal']['medalha5'] == "TRUE" ){?>
                                  ...
                                  <div class="card-text">
                                    <img  class="imagem" src="../img/m5.png">
                                    <p class="imagem"> Recolher recicláveis</p>
                                  </div>
                              ...
                              <div class="col-md-3 mt-4">
                                ...
                                <?php if ($_SESSION['medal']['medalha6'] == "TRUE" ){?>
                                  ...
                                  <div class="card-text">
                                    <img  class="imagem" src="../img/m6.png">
                                    <p class="imagem"> Usar sacolas retornáveis</p>
                                  </div>
                              ...
                              <div class="col-md-3 mt-4">
                                ...
                                <?php if ($_SESSION['medal']['medalha7'] == "TRUE" ){?>
                                  ...
                                  <div class="card-text">
                                    <img class="imagem" src="../img/m7.png">
                                    <p class="imagem"> Plantar broto de feijão</p>
                                  </div>
                              ...
                              <div class="col-md-3 mt-4">
                                ...
                                <?php if ($_SESSION['medal']['medalha8'] == "TRUE" ){?>
                                  ...
                                  <div class="card-text">
                                    <img class="imagem" src="../img/m8.png">
                                    <p class="imagem"> Retirar água parada</p>
                                  </div>
                              ...
                              <div class="col-md-3 mt-4">
                                ...
                                <?php if ($_SESSION['medal']['medalha9'] == "TRUE" ){?>
                                  ...
                                  <div class="card-text">
                                    <img class="imagem" src="../img/m9.png">
                                    <p class="imagem"> Cores de cada lixeira de recicláveis</p>
                                  </div>
