...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container-fluid text-center pb-2 titulo">
       <h1 class="tituloAtualizar"><img class="iconPerfil" src="../img/iconPerfil.png" alt=""> Atualize seu Cadastro </h1><br/>
    </div>
      
      
        <div class="card-body">
          <form action="../../backend/api/user/updat.php" method="POST">
            
            <div class="form-group">
                <input type="hidden" id="id" name="id" class="form-control" value="<?php echo $_SESSION['user']['id']; ?>" required>

                <label>Nome</label>
                <input type="text" name="nome" value="<?php echo $_SESSION['user']['nome']; ?>" id="nome" class="form-control" maxlength="25"  minlength="5"  class="form-control" pattern="^[^-\s][a-zA-ZÀ-ú ]*" required/>
            
                <label>Data de nascimento</label>
                <input type="date" name="dataNascimento" value="<?php echo $_SESSION['user']['dataNascimento']; ?>" maxlength="10" pattern="dd-mm-yyyy" min="1900-01-01" max="2020-01-30" class="form-control"/> 
            
                <label>E-mail</label>
                <input type="email" name="email" value="<?php echo $_SESSION['user']['email']; ?>" class="form-control" maxlength="50" required/>
                ...
                <select class="selecao mb-3" name="categoriaSecreta" id="categoriaSecreta" required>
                    <option value="<?php echo $_SESSION['user']['categoriaSecreta']; ?>" selected><?php echo $_SESSION['user']['categoriaSecreta']; ?></option>
                ...
                <label>Apelido:</label>
                <input type="text" name="apelido" id="apelido" value="<?php echo $_SESSION['user']['apelido']; ?>" class="form-control" pattern="^[^-\s][a-zA-ZÀ-ú ]*" required/>
                ...
                <div class="col-sm">
                  <div class="personagem">
                    <div class="form-check">
                      ...
                      <input class="form-check-input" type="radio" name="imgAvatar" id="imgAvatar" value="perso1.png" checked required/>
