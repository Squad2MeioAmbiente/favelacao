...
<link rel="stylesheet" href="<?php $_SERVER['SERVER_NAME'] ?>/favelacao/frontend/pages/templates/menu/css/menu.css"/>
	...
	<nav class="menu navbar fixed-top navbar-expand-lg navbar-fixed-top hover">
		<div class="container">
			...
			<div id="links-menu" class="collapse navbar-collapse hover">
				<ul class="navbar-nav ml-auto">
					...
					<!-- <li class="nav-item">
						<a class="nav-link" href="<?php $_SERVER['SERVER_NAME'] ?>/Painel-ADM-FavelAcao/index.php"> Admin</a> 
					</li>
					 -->
					<?php if (!isset($_SESSION)) session_start();
        				if (!isset($_SESSION['user']['email'])){?>
